...
export default function ({ navigation }) {
    ...
    const getDataAPI = (x) => {
        ...
        getData('user').then(res => {
            ...
            axios.post('https://simenawan.mpssukorejo.com/api/pendidikan_data.php', {
                id_karyawan: res.id_karyawan
            }).then(r => {

                setIsData(true);
                setData(r.data);
                console.warn('pendidikan_data', r.data)
            })
    ...
    const hapus = (id) => {
        ...
        axios.post('https://simenawan.mpssukorejo.com/api/pendidikan_delete.php', {
            id: id
        }).then(r => {
        ...
        <SafeAreaView>
            <ScrollView>
                <View style={{ padding: 10, alignItems: 'center', backgroundColor: colors.primary, flexDirection: 'row' }}>
                    ...
                    >Data Pendidikan</Text>
                    <View style={{

                        flex: 1
                    }}>
                        <MyButton onPress={() => navigation.navigate('MenuPendidikanAdd', {
                    ...
                    return (
                        <View style={{ margin: 5, padding: 10 }}>
                            ...
                            <View style={{ paddingVertical: 10, flexDirection: 'row' }}>
                                <TouchableOpacity onPress={() => navigation.navigate('MenuPendidikanEdit', item)} style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: colors.primary, padding: 20, marginRight: 5 }}>
                                    <Text style={{
                                        fontFamily: fonts.secondary[600],
                                        fontSize: windowWidth / 25,
                                        color: colors.white,
