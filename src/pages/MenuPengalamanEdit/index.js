...
export default function ({ navigation, route }) {
    ...
    const _kirimAPI = () => {
        ...
        axios.post('https://simenawan.mpssukorejo.com/api/pengalaman_update.php', kirim).then(res => {
            setLoading(false);
    ...
    return (
        <ScrollView>
            <View style={{
                ...
                <DatePicker title="tgl_masuk" mode="date" date={new Date(kirim.tgl_masuk)} onDateChange={val => setKirim({
                    ...kirim,
                    tgl_masuk: val
                })} />
                <Text style={{
                ...
                <DatePicker title="tgl_keluar" mode="date" date={new Date(kirim.tgl_keluar)} onDateChange={val => setKirim({
                    ...kirim,
                    tgl_keluar: val
                })} />
