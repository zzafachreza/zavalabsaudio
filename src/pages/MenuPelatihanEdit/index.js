...
export default function ({ navigation, route }) {
    ...
    const _kirimAPI = () => {
        ...
        axios.post('https://simenawan.mpssukorejo.com/api/pelatihan_update.php', kirim).then(res => {
            setLoading(false);
    ...
    return (
        <ScrollView>
            <View style={{
                ...
                <DatePicker title="tgl_mulai" mode="date" date={new Date(kirim.tgl_mulai)} onDateChange={val => setKirim({
                    ...kirim,
                    tgl_mulai: val
                })} />
                <Text style={{
                ...
                <DatePicker title="tgl_selesai" mode="date" date={new Date(kirim.tgl_selesai)} onDateChange={val => setKirim({
                    ...kirim,
                    tgl_selesai: val
                })} />
