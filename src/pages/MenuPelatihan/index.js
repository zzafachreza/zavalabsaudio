            ...
            <ScrollView>
                <View style={{ padding: 10, alignItems: 'center', backgroundColor: colors.primary, flexDirection: 'row' }}>
                    ...
                    <View style={{
                        ...
                        <MyButton onPress={() => navigation.navigate('MenuPelatihanAdd', {
                    ...
                    return (
                        <View style={{ margin: 5, padding: 10 }}>
                            ...
                            <View style={{ paddingVertical: 10, flexDirection: 'row' }}>
                                <TouchableOpacity onPress={() => navigation.navigate('MenuPelatihanEdit', item)} style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: colors.primary, padding: 20, marginRight: 5 }}>
                                    <Text style={{
                                        fontFamily: fonts.secondary[600],
                                        fontSize: windowWidth / 25,
                                        color: colors.white,
